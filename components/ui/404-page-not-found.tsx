...
export function NotFoundPageComponent() {
	return (
		<section className="bg-white font-serif min-h-[calc(100vh-10rem-2px)] flex items-center justify-center">
				...
				<div className="flex justify-center">
					<div className="w-full sm:w-10/12 md:w-8/12 text-center">
						<div
							...
							aria-hidden="true"
						>
							<h1 className="font-black text-center text-black text-6xl sm:text-7xl md:text-8xl pt-6 sm:pt-8">
								404
							</h1>
						</div>
